...
<head>
    ...
    <script>
        ...
        // Script chuyển đổi giá từ dạng ký hiệu khoa học sang số nguyên
        $(document).ready(function () {
            var priceVal = $("#price").val(); // ví dụ: "1.2E7"
            var formatted = Number(priceVal).toFixed(0); // Chuyển đổi thành "12000000"
            $("#price").val(formatted);
        });
    </script>
</head>
        ...
        <div id="layoutSidenav_content">
            <div class="row col-md-6 col-12 mx-auto">
                <div>
                    ...
                    <hr>
                    <form:form action="/admin/product/update" method="post" modelAttribute="product" class="mt-5 row" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 col-md-6 col-12">
                            <img src="/images/product/${product.image}" id="avatarPreview" style="display: none; max-width: 250px; max-height: 250px;" class="d-block mx-auto mb-3" />
                        </div>
                        <div>
